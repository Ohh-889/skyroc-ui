  ...
  return (
    ...
    >
      <Collapsible
        ...
        content={
          <>
            <div className="border rounded-md px-4 py-3 text-sm font-mono">@skyroc-ui/colors</div>
            <div className="border rounded-md px-4 py-3 text-sm font-mono">skyroc-ui</div>
          </>
        }
      >
        ...
        <div className="border rounded-md px-4 py-3 text-sm font-mono">@skyroc-ui/primitives</div>
      </Collapsible>
    </Card>
  );
};
